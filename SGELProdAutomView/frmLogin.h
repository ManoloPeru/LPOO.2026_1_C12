...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtContrasenia->Size = System::Drawing::Size(262, 28);
			...
			this->txtUsuario->Size = System::Drawing::Size(262, 28);
			...
			this->Text = L"Sistema Gestión de Ensamblaje - Autentificación";
...
#pragma endregion
	private: System::Void btnIngresar_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			// Aquí se puede agregar la lógica para verificar las credenciales del usuario: Archivo plano, Base de datos, etc.
